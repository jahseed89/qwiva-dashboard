...
const CareersCard: React.FC<CareersCardProps> = ({
  ...
  return (
    <div className="flex justify-start items-center w-[80%] md:w-[60%] lg:w-[250px] px-5 py-7 lg:p-5 mx-auto lg:mx-0 shadow-md bg-white-100 rounded-2xl c-card">
      {icon}
      <div className="flex justify-start flex-col pl-8 md:pl-16 lg:pl-4">
        ...
        <div className="flex bg-white-100 items-center">
          ...
          <span className="pl-4 md:pl-8 lg:pl-4 text-sm text-green-100">{rate}</span>
        </div>
      </div>
    </div>
  );
